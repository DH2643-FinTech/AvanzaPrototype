...
export const serverUrlBuilderCompanies = ({
  name,
  randomCount,
}: ServerCompaniesUrlParams): string => {
...
export const avanzaUrlBuilderStockPriceTimePeriod = ({
  companyId,
  toDate,
  resolution,
  defaultTimePeriod,
...
export const detailUrl =
  "https://www.avanza.se/_api/market-guide/stock/1144920/details";
...
export const detailOptions: RequestInit = {
  ...
  headers: {
    ...
    "accept-language":
      "sv-SE,sv;q=0.9,fa-IR;q=0.8,fa;q=0.7,en-US;q=0.6,en;q=0.5",
    "content-type": "application/json;charset=UTF-8",
    cookie:
      "AZACOOKIECONSENT_UX=YES; AZACOOKIECONSENT_ANALYSIS=YES; AZACOOKIECONSENT_MARKETING=YES; PAGE_ANALYTICS=14e7d08c-0bac-44a7-b659-53c6178e64ba; AZAPERSISTENCE=0253c8bd2e-1942-407DZRx-39-h6nYEs_a77rQlCEMn6CbMODMeMtv2IsL0jcpZse28HiiaOGI6InaRK7b_8",
